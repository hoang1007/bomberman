...
/**
 * Bản đồ mô tả vị trí có thể đến và không thể đến trong map.
 * Cần để A* có thể tìm đường.
 */
public class MovableMap {
    ...
    public MovableMap(Vector2D position, Vector2D dimension) {
        if (validateMap(position, dimension)) {
            ...
            throw new UnsupportedOperationException("Position and dimension must be multiple of GRID_SIZE");
        }
    }
